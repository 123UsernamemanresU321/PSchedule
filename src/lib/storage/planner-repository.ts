...
const PLANNING_MODEL_VERSION = "2026-03-20-olympiad-frontier-v29";
...
export async function resetFutureAutoGeneratedOlympiadBlocks(referenceDate = new Date()) {
...
export async function repairOlympiadPlanningState(referenceDate = new Date()) {
  ...
  await resetFutureAutoGeneratedOlympiadBlocks(referenceDate);
