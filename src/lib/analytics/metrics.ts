...
export function getCalendarCompletionForecast(options: {
  ...
  return {
    ...
    targetHours: roundHoursToQuarter(targetHours),
    completedHours: roundHoursToQuarter(effectiveCompletedHours),
    remainingTargetHours: roundHoursToQuarter(remainingTargetHours),
