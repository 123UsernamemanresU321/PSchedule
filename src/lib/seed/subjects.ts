...
export function buildSeedSubjects(referenceDate = new Date()): Subject[] {
  ...
  return [
    ...
    },
    {
      ...
      shortName: "English A",
      category: "english",
      description: "Non-core English A SL tracking with post-syllabus weekly paper practice only.",
    ...
    },
    {
      ...
      shortName: "French Ab Initio",
      category: "french",
      description: "Light twice-weekly tune-ups plus post-syllabus weekly French Ab Initio paper practice.",
    ...
    },
    {
      ...
      name: "Geography HL",
      shortName: "Geography HL",
      category: "geography",
      description: "Non-core Geography HL tracking with post-syllabus weekly paper practice only.",
...
export function buildSeedGoals(referenceDate = new Date()): Goal[] {
  const firstSchoolMilestoneDeadline = `${referenceDate.getFullYear()}-10-31`;
  const mathsFirstSchoolMilestoneDeadline = `${referenceDate.getFullYear()}-10-31`;
